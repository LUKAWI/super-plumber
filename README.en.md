...
# Tests (96 cases: state machine / topology / CLI / MCP protocol)
npm test
...
```text
Tests: 96/96 ✅ | CLI: 11 commands | MCP: 9 tools | State machine: 7 states / 14 transitions | Edge types: 7 | Web UI: Svelte 5 + D3.js
```

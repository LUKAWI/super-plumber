...
1. **工作类定档**（这个活是什么量级）→ 回 plumber-design **Phase 0 路由表**两问定档 quick / standard / program（DEC-2）：本插件包 `./skills/plumber-design/SKILL.md`（pi 渠道为 `.pi/skills/plumber-design/SKILL.md`）。

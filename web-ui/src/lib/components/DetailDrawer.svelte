<!--
  DetailDrawer — 右缘悬浮玻璃抽屉的共享舱体（2026-08-28 详情页组件化）。
  节点/上下文/决策文档/边/版本对比五种详情共用同一壳：头部（标题+Esc 提示+关闭）、
  玻璃面板几何、通用小节排版（section/chip/meta 类经 :global 下放，单一真相源）。
-->
<script lang="ts">
